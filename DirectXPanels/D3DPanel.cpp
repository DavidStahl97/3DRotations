...
void D3DPanel::StartRenderLoop(Platform::WriteOnlyArray<float>^ test)
{
...
void D3DPanel::CreateDeviceResources()
{
    ...
    auto createCubeTask = (createPSTask && createVSTask).then([this]() {
        ...
        static const VertexPositionColor cubeVertices [] =
        {
            ...
            { XMFLOAT3(0.5f, 0.5f, -0.1f), XMFLOAT3(1.0f, 1.0f, 0.0f) },
            { XMFLOAT3(0.5f, 0.5f, 0.8f), XMFLOAT3(1.0f, 1.0f, 1.0f) },
        };
